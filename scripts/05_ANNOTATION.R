...
REFERENCE_ADD_SP <- "silva_v138.2_assignSpecies.fa.gz"
...
if (str_detect(REFERENCE, "silva") & !all(colnames(taxa) == "Species")) taxa <- addSpecies(taxa, paste0(REF_PATH, "/", REFERENCE_ADD_SP))
